...
Exp=$(curl -sS https://raw.githubusercontent.com/Lvv7/permission/main/ipmini | grep $MYIP | awk '{print $3}')
fi
...
export sem=$( curl -s https://raw.githubusercontent.com/Lvv7/v5/main/versions)
...
11) clear ; wget https://raw.githubusercontent.com/Lvv7/v5/main/kyt.sh && chmod +x kyt.sh && ./kyt.sh ;;
12) clear ; lock ;;
13) clear ; unlock ;;
14) clear ; update ;;
0) clear ; menu ;;
